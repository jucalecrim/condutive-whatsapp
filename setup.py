...
setup(
    ...
    package_dir={"": "src"},
    install_requires=['fastapi', 'numpy', 'pandas', 'datetime', 'flask', 'gunicorn', 'uvicorn', 'requests', 'validate_docbr', 'psycopg2-binary', 'python-Levenshtein', 'PyMuPDF', 'python-docx', 'python-dateutil', 'python-multipart'],
